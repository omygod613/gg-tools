-- Oracle Free 23c setup for Debezium CDC test
-- SID: FREE, PDB: FREEPDB1
-- Run as: sqlplus / as sysdba
...
-- Switch to PDB for creating DEMO user and table
ALTER SESSION SET CONTAINER=FREEPDB1;

-- Create DEMO user in PDB
DECLARE
  user_exists NUMBER;
BEGIN
  ...
  IF user_exists = 0 THEN
    ...
    EXECUTE IMMEDIATE 'GRANT CONNECT, RESOURCE, UNLIMITED TABLESPACE TO DEMO';
  END IF;
END;
/
