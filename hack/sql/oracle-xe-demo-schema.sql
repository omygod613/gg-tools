-- Create DEMO schema and source table (Oracle XE 21c)
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'GRANT CONNECT, RESOURCE, CREATE SESSION TO DEMO';
EXCEPTION
  WHEN OTHERS THEN
...
-- Verify
SELECT COUNT(*) AS ROW_COUNT FROM DEMO.SOURCE_ORDERS;
